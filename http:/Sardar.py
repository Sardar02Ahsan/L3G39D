#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Sardar
...
def pkgs():
        love("\033[1;91m«-----------------\033[1;96mSARDAR\033[1;91m-----------------»")
        ...
        love("\033[1;91m«------------------SARDAR----------------»")
        love("\033[1;95mS4SARDAR 2nd Tool Start ComingSoon New Update»")
...
##### LOGO #####
logo = """
\033[1;96mPAK HACKERS░░░\033[1;92m░░░SARDAR╗░░WEBDEVELOPER╗░AND╗░░A\033[1;91mETICALHACKER╗
\033[1;96mYT╔══M4╗B4║░\033[1;92m░░░░WEBHACKER╔══PAK╗ANONAYMOUS╔══YOUTUBE╗CHANNEL║\033[1;91m░S4 sardar_M4_MASTER╔╝
\033[1;96mPAKISTANI╦╝HACKERS\033[1;92m║░░░░░███████║██║░░╚═╝\033[1;91m█████═╝░
\033[1;96mWEBHACKER╔══SARDAR╗\033[1;92m██║░░░░░██╔══██║██║░░\033[1;91m██╗██╔═██╗░
\033[1;96mWHATSAPP\033[1;92m╦╝03232132362╗██║░░██║╚█\033[1;91m████╔╝██║░╚██╗
\033[1;96m╚═══\033[1;92m══╝░╚══════╝╚═╝░░╚═╝\033[1;91m░╚════╝░╚═╝░░╚═╝
\033[1;96mHACK\033[1;92mTHE╗░░░HACKERS╗░SARDAR╗░HACKERS\033[1;91m████╗██╗░█████╗░
\033[1;96mWE\033[1;92mARE╗░LEGION║WE╔══NEVER╗\033[1;91mFORGIVE╔════╝SPEED█║LIMIT█╔══INCREASED█╗
\033[1;92mVISIT╔█OUR█╔YT║█CHANNEL█\033[1;91mB4║█SARDAR█╗░░M4║██MASTER██║
\033[1;92m██║╚██╔╝██║██╔\033[1;91m══██║██╔══╝░░██║██╔══██║
\033[1;92m██║░╚═╝░██║█\033[1;91m█║░░██║██║░░░░░██║██║░░██║
\033[1;92m╚═╝░░░░░╚═\033[1;91m╝╚═╝░░╚═╝╚═╝░░░░░╚═╝╚═╝░░╚═╝
...
\033[1;96m«-----------------\033[1;91mSARDAR\033[1;96m-----------------»"""
...
def menu():
    ...
    print(logo)
    os.system('clear')
    os.system('echo  SARDAR░░░░░░Monster░░PAKISTANI░ETICAL░░HACKER | lolcat -a -F 0.1')
    os.system('echo  Sardar░░░░░monster██WEB██DEVELOPER░██ | lolcat -a -F 0.1')
    os.system('echo  WHATSAPP░░░░░+92 322 7152175░░FOR THIS SCRIPT░ | lolcat -a -F 0.1')
    os.system('echo  CONTACT  ░░░░░ME ON WHATSAPP░░Sardar CYBER HACKER░ | lolcat -a -F 0.1')
    ...
    os.system('echo  SHABIR BALOCH WHATSAPP = +92 322 7152175| lolcat -a -F 0.1')
    os.system('echo  VISIT OUR YOUTUBE CHANNEL s4 sardar M4 MASTER | lolcat -a -F 0.1')
    ...
    os.system('echo  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  SARDAR| lolcat --animate')
    os.system('echo  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  SARDARHACKER| lolcat --animate')
    os.system('echo  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈| lolcat')
    os.system('echo  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   WhatsApp| lolcat --animate')
    os.system('echo  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈+92 322 7152175| lolcat --animate')
    os.system('echo -----------------SARDAR MONSTER----------------| lolcat --animate')
    ...
    time.sleep(0.0005)
    os.system('echo [1]  Install Random Mail Cloning--------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [2]  Install Email Cloning--------------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [3]  Install Manual Password------------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [4]  Install Group Cloning--------------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [5]  Install With Out Fb Id-------------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [5]  Install Facebook Target------------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [6]  Install SpiderMan------------------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [7]  Install Kalilinux------------------------- Tool ----●  | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [8]  Install BlackHat-------------------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [9]  Install RedMoonNew------------------------ Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [10]  Install love3Hack3r----------------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [11]  Install B4 BALOCH Clonnig----------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [12]  Install Web Admin Panel Finder------------ Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [13]  Install Attacker-------------------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [14]  Install Payload--------------------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [15]  Install CamHacker------------------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [16]  Install Compiler-------------------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [17]  Install Instagram Brut-------------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [18]  Install Marsh Base------------------------ Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [19]  Install Gmail Target---------------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [20]  Install Termux Logo----------------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [21]  Install Termux TBomb---------------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [22]  B4 BALOCH M4 MASTER WhatsApp Group-------- Tool----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [23]  BlackMafia Dragon404 New Update -----● | lolcat -a -F 0.01')
    time.sleep(0.0005)
    os.system('echo [24]  Tool Update--------------------------● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [25]  EXIT | lolcat -a -F 0.1')
    time.sleep(0.0005)
